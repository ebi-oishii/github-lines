...
「ツリーマップ」ボタンを押すと、**面積が行数**のビューに切り替わります。ディレクトリをクリックすると中に入れます。
...
ツールバーにピン留めしているなら、アイコンをクリックすると開きます。ピン留めしていない場合は `chrome://extensions` の GitHub Lines から「拡張機能のオプション」をクリックしてください。
...
3. 「検証してオーナーを自動取得」を押す。そのトークンで実際に読めるアカウントと組織が埋まります
